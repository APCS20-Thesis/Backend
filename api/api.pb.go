...
var file_api_proto_goTypes = []interface{}{
	...
	(*GetListDataActionsRequest)(nil),                 // 55: api.GetListDataActionsRequest
	(*GetListDataActionsResponse)(nil),                // 56: api.GetListDataActionsResponse
	(*GetListDataSourcesResponse_DataSource)(nil),     // 57: api.GetListDataSourcesResponse.DataSource
	nil, // 58: api.GetDataSourceResponse.ConfigurationsEntry
	nil, // 59: api.GetDataSourceResponse.MappingOptionsEntry
	(*GetListDataTablesResponse_DataTable)(nil), // 60: api.GetListDataTablesResponse.DataTable
	nil, // 61: api.CreateConnectionRequest.ConfigurationsEntry
	(*GetListConnectionsResponse_Connection)(nil), // 62: api.GetListConnectionsResponse.Connection
	nil, // 63: api.GetConnectionResponse.ConfigurationsEntry
	nil, // 64: api.UpdateConnectionRequest.ConfigurationsEntry
	(*GetListFileExportRecordsResponse_FileExportRecord)(nil), // 65: api.GetListFileExportRecordsResponse.FileExportRecord
	(*CreateMasterSegmentRequest_AttributeTable)(nil),         // 66: api.CreateMasterSegmentRequest.AttributeTable
	(*CreateMasterSegmentRequest_BehaviorTable)(nil),          // 67: api.CreateMasterSegmentRequest.BehaviorTable
	(*GetMasterSegmentDetailResponse_AttributeTable)(nil),     // 68: api.GetMasterSegmentDetailResponse.AttributeTable
	(*GetMasterSegmentDetailResponse_BehaviorTable)(nil),      // 69: api.GetMasterSegmentDetailResponse.BehaviorTable
	(*GetSegmentDetailResponse_Rule)(nil),                     // 70: api.GetSegmentDetailResponse.Rule
	(*Account)(nil),                                           // 71: api.Account
	(*MappingOptionItem)(nil),                                 // 72: api.MappingOptionItem
	(*ImportCsvConfigurations)(nil),                           // 73: api.ImportCsvConfigurations
	(*SchemaColumn)(nil),                                      // 74: api.SchemaColumn
	(*TransferredColumn)(nil),                                 // 75: api.TransferredColumn
	(*MasterSegment)(nil),                                     // 76: api.MasterSegment
	(*Rule)(nil),                                              // 77: api.Rule
	(*BehaviorCondition)(nil),                                 // 78: api.BehaviorCondition
	(*Segment)(nil),                                           // 79: api.Segment
	(*MappingGophishProfile)(nil),                             // 80: api.MappingGophishProfile
	(*DataDestination)(nil),                                   // 81: api.DataDestination
	(*DataAction)(nil),                                        // 82: api.DataAction
	(*EnrichedDataSource)(nil),                                // 83: api.EnrichedDataSource
	(*EnrichedDataDestination)(nil),                           // 84: api.EnrichedDataDestination
}
var file_api_proto_depIdxs = []int32{
	71, // 0: api.LoginResponse.account:type_name -> api.Account
	71, // 1: api.GetAccountInfoResponse.account:type_name -> api.Account
	72, // 2: api.ImportCsvRequest.mapping_options:type_name -> api.MappingOptionItem
	73, // 3: api.ImportCsvRequest.configurations:type_name -> api.ImportCsvConfigurations
	57, // 4: api.GetListDataSourcesResponse.results:type_name -> api.GetListDataSourcesResponse.DataSource
	58, // 5: api.GetDataSourceResponse.configurations:type_name -> api.GetDataSourceResponse.ConfigurationsEntry
	59, // 6: api.GetDataSourceResponse.mapping_options:type_name -> api.GetDataSourceResponse.MappingOptionsEntry
	60, // 7: api.GetListDataTablesResponse.results:type_name -> api.GetListDataTablesResponse.DataTable
	74, // 8: api.GetDataTableResponse.schema:type_name -> api.SchemaColumn
	61, // 9: api.CreateConnectionRequest.configurations:type_name -> api.CreateConnectionRequest.ConfigurationsEntry
	62, // 10: api.GetListConnectionsResponse.results:type_name -> api.GetListConnectionsResponse.Connection
	63, // 11: api.GetConnectionResponse.configurations:type_name -> api.GetConnectionResponse.ConfigurationsEntry
	64, // 12: api.UpdateConnectionRequest.configurations:type_name -> api.UpdateConnectionRequest.ConfigurationsEntry
	65, // 13: api.GetListFileExportRecordsResponse.results:type_name -> api.GetListFileExportRecordsResponse.FileExportRecord
	72, // 14: api.ImportCsvFromS3Request.mapping_options:type_name -> api.MappingOptionItem
	73, // 15: api.ImportCsvFromS3Request.configurations:type_name -> api.ImportCsvConfigurations
	75, // 16: api.CreateMasterSegmentRequest.selected_columns:type_name -> api.TransferredColumn
	66, // 17: api.CreateMasterSegmentRequest.attribute_tables:type_name -> api.CreateMasterSegmentRequest.AttributeTable
	67, // 18: api.CreateMasterSegmentRequest.behavior_tables:type_name -> api.CreateMasterSegmentRequest.BehaviorTable
	76, // 19: api.GetListMasterSegmentsResponse.results:type_name -> api.MasterSegment
	68, // 20: api.GetMasterSegmentDetailResponse.attribute_tables:type_name -> api.GetMasterSegmentDetailResponse.AttributeTable
	69, // 21: api.GetMasterSegmentDetailResponse.behavior_tables:type_name -> api.GetMasterSegmentDetailResponse.BehaviorTable
	74, // 22: api.GetMasterSegmentDetailResponse.audience_schema:type_name -> api.SchemaColumn
	77, // 23: api.CreateSegmentRequest.condition:type_name -> api.Rule
	78, // 24: api.CreateSegmentRequest.behavior_conditions:type_name -> api.BehaviorCondition
	79, // 25: api.GetListSegmentsResponse.results:type_name -> api.Segment
	70, // 26: api.GetSegmentDetailResponse.condition:type_name -> api.GetSegmentDetailResponse.Rule
	74, // 27: api.GetSegmentDetailResponse.schema:type_name -> api.SchemaColumn
	80, // 28: api.CreateGophishUserGroupFromSegmentRequest.mapping:type_name -> api.MappingGophishProfile
	81, // 29: api.GetListDataDestinationsResponse.results:type_name -> api.DataDestination
	82, // 30: api.GetListDataActionsResponse.results:type_name -> api.DataAction
	83, // 31: api.GetListDataTablesResponse.DataTable.data_sources:type_name -> api.EnrichedDataSource
	84, // 32: api.GetListDataTablesResponse.DataTable.data_destinations:type_name -> api.EnrichedDataDestination
	83, // 33: api.GetListConnectionsResponse.Connection.data_sources:type_name -> api.EnrichedDataSource
	84, // 34: api.GetListConnectionsResponse.Connection.data_destinations:type_name -> api.EnrichedDataDestination
	75, // 35: api.CreateMasterSegmentRequest.AttributeTable.selected_columns:type_name -> api.TransferredColumn
	75, // 36: api.CreateMasterSegmentRequest.BehaviorTable.selected_columns:type_name -> api.TransferredColumn
	75, // 37: api.GetMasterSegmentDetailResponse.AttributeTable.selected_columns:type_name -> api.TransferredColumn
	74, // 38: api.GetMasterSegmentDetailResponse.BehaviorTable.schema:type_name -> api.SchemaColumn
	70, // 39: api.GetSegmentDetailResponse.Rule.rules:type_name -> api.GetSegmentDetailResponse.Rule
	0,  // 40: api.CDPService.CheckHealth:input_type -> api.CheckHealthRequest
	1,  // 41: api.CDPService.Login:input_type -> api.LoginRequest
	3,  // 42: api.CDPService.SignUp:input_type -> api.SignUpRequest
	4,  // 43: api.CDPService.GetAccountInfo:input_type -> api.GetAccountInfoRequest
	9,  // 44: api.CDPService.GetListDataSources:input_type -> api.GetListDataSourcesRequest
	11, // 45: api.CDPService.GetDataSource:input_type -> api.GetDataSourceRequest
	13, // 46: api.CDPService.GetListDataTables:input_type -> api.GetListDataTablesRequest
	15, // 47: api.CDPService.GetDataTable:input_type -> api.GetDataTableRequest
	17, // 48: api.CDPService.GetQueryDataTable:input_type -> api.GetQueryDataTableRequest
	23, // 49: api.CDPService.GetConnection:input_type -> api.GetConnectionRequest
	21, // 50: api.CDPService.GetListConnections:input_type -> api.GetListConnectionsRequest
	19, // 51: api.CDPService.CreateConnection:input_type -> api.CreateConnectionRequest
	25, // 52: api.CDPService.UpdateConnection:input_type -> api.UpdateConnectionRequest
	27, // 53: api.CDPService.DeleteConnection:input_type -> api.DeleteConnectionRequest
	29, // 54: api.CDPService.ExportDataToFile:input_type -> api.ExportDataToFileRequest
	33, // 55: api.CDPService.ImportCsvFromS3:input_type -> api.ImportCsvFromS3Request
	31, // 56: api.CDPService.GetListFileExportRecords:input_type -> api.GetListFileExportRecordsRequest
	35, // 57: api.CDPService.CreateMasterSegment:input_type -> api.CreateMasterSegmentRequest
	37, // 58: api.CDPService.GetListMasterSegments:input_type -> api.GetListMasterSegmentsRequest
	39, // 59: api.CDPService.GetMasterSegmentDetail:input_type -> api.GetMasterSegmentDetailRequest
	41, // 60: api.CDPService.CreateSegment:input_type -> api.CreateSegmentRequest
	43, // 61: api.CDPService.GetListSegments:input_type -> api.GetListSegmentsRequest
	45, // 62: api.CDPService.GetSegmentDetail:input_type -> api.GetSegmentDetailRequest
	47, // 63: api.CDPService.CreateGophishUserGroupFromSegment:input_type -> api.CreateGophishUserGroupFromSegmentRequest
	49, // 64: api.CDPService.ImportFromMySQLSource:input_type -> api.ImportFromMySQLSourceRequest
	51, // 65: api.CDPService.ExportToMySQLDestination:input_type -> api.ExportToMySQLDestinationRequest
	53, // 66: api.CDPService.GetListDataDestinations:input_type -> api.GetListDataDestinationsRequest
	55, // 67: api.CDPService.GetListDataActions:input_type -> api.GetListDataActionsRequest
	6,  // 68: api.CDPService.CheckHealth:output_type -> api.CommonResponse
	2,  // 69: api.CDPService.Login:output_type -> api.LoginResponse
	6,  // 70: api.CDPService.SignUp:output_type -> api.CommonResponse
	5,  // 71: api.CDPService.GetAccountInfo:output_type -> api.GetAccountInfoResponse
	10, // 72: api.CDPService.GetListDataSources:output_type -> api.GetListDataSourcesResponse
	12, // 73: api.CDPService.GetDataSource:output_type -> api.GetDataSourceResponse
	14, // 74: api.CDPService.GetListDataTables:output_type -> api.GetListDataTablesResponse
	16, // 75: api.CDPService.GetDataTable:output_type -> api.GetDataTableResponse
	18, // 76: api.CDPService.GetQueryDataTable:output_type -> api.GetQueryDataTableResponse
	24, // 77: api.CDPService.GetConnection:output_type -> api.GetConnectionResponse
	22, // 78: api.CDPService.GetListConnections:output_type -> api.GetListConnectionsResponse
	20, // 79: api.CDPService.CreateConnection:output_type -> api.CreateConnectionResponse
	26, // 80: api.CDPService.UpdateConnection:output_type -> api.UpdateConnectionResponse
	28, // 81: api.CDPService.DeleteConnection:output_type -> api.DeleteConnectionResponse
	30, // 82: api.CDPService.ExportDataToFile:output_type -> api.ExportDataToFileResponse
	34, // 83: api.CDPService.ImportCsvFromS3:output_type -> api.ImportCsvFromS3Response
	32, // 84: api.CDPService.GetListFileExportRecords:output_type -> api.GetListFileExportRecordsResponse
	36, // 85: api.CDPService.CreateMasterSegment:output_type -> api.CreateMasterSegmentResponse
	38, // 86: api.CDPService.GetListMasterSegments:output_type -> api.GetListMasterSegmentsResponse
	40, // 87: api.CDPService.GetMasterSegmentDetail:output_type -> api.GetMasterSegmentDetailResponse
	42, // 88: api.CDPService.CreateSegment:output_type -> api.CreateSegmentResponse
	44, // 89: api.CDPService.GetListSegments:output_type -> api.GetListSegmentsResponse
	46, // 90: api.CDPService.GetSegmentDetail:output_type -> api.GetSegmentDetailResponse
	48, // 91: api.CDPService.CreateGophishUserGroupFromSegment:output_type -> api.CreateGophishUserGroupFromSegmentResponse
	50, // 92: api.CDPService.ImportFromMySQLSource:output_type -> api.ImportFromMySQLSourceResponse
	52, // 93: api.CDPService.ExportToMySQLDestination:output_type -> api.ExportToMySQLDestinationResponse
	54, // 94: api.CDPService.GetListDataDestinations:output_type -> api.GetListDataDestinationsResponse
	56, // 95: api.CDPService.GetListDataActions:output_type -> api.GetListDataActionsResponse
