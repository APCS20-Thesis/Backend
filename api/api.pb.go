...
var file_api_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x32, 0xa9, 0x14, 0x0a, 0x0a, 0x43, 0x44, 0x50, 0x53,
	...
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x7f, 0x0a, 0x10, 0x55, 0x70, 0x64,
	...
	0x02, 0x28, 0x3a, 0x01, 0x2a, 0x22, 0x23, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x64,
	0x61, 0x74, 0x61, 0x2d, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2f, 0x63, 0x6f, 0x6e, 0x6e, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x7c, 0x0a, 0x10, 0x44, 0x65,
	...
	0x70, 0x6f, 0x72, 0x74, 0x12, 0x7a, 0x0a, 0x0f, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x43, 0x73,
	...
	0x69, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x65, 0x0a, 0x0f,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*GetListDataSourcesResponse_DataSource)(nil), // 45: api.GetListDataSourcesResponse.DataSource
	nil, // 46: api.GetDataSourceResponse.ConfigurationsEntry
	nil, // 47: api.GetDataSourceResponse.MappingOptionsEntry
	(*GetListDataTablesResponse_DataTable)(nil), // 48: api.GetListDataTablesResponse.DataTable
	nil, // 49: api.CreateConnectionRequest.ConfigurationsEntry
	(*GetListConnectionsResponse_Connection)(nil), // 50: api.GetListConnectionsResponse.Connection
	nil, // 51: api.GetConnectionResponse.ConfigurationsEntry
	nil, // 52: api.UpdateConnectionRequest.ConfigurationsEntry
	(*GetListFileExportRecordsResponse_FileExportRecord)(nil), // 53: api.GetListFileExportRecordsResponse.FileExportRecord
	(*CreateMasterSegmentRequest_AttributeTable)(nil),         // 54: api.CreateMasterSegmentRequest.AttributeTable
	(*CreateMasterSegmentRequest_BehaviorTable)(nil),          // 55: api.CreateMasterSegmentRequest.BehaviorTable
	(*GetMasterSegmentDetailResponse_AttributeTable)(nil),     // 56: api.GetMasterSegmentDetailResponse.AttributeTable
	(*GetMasterSegmentDetailResponse_BehaviorTable)(nil),      // 57: api.GetMasterSegmentDetailResponse.BehaviorTable
	(*CreateSegmentRequest_Rule)(nil),                         // 58: api.CreateSegmentRequest.Rule
	(*Account)(nil),                                           // 59: api.Account
	(*MappingOptionItem)(nil),                                 // 60: api.MappingOptionItem
	(*ImportCsvConfigurations)(nil),                           // 61: api.ImportCsvConfigurations
	(*SchemaColumn)(nil),                                      // 62: api.SchemaColumn
	(*TransferredColumn)(nil),                                 // 63: api.TransferredColumn
	(*MasterSegment)(nil),                                     // 64: api.MasterSegment
	(*Segment)(nil),                                           // 65: api.Segment
}
var file_api_proto_depIdxs = []int32{
	59, // 0: api.LoginResponse.account:type_name -> api.Account
	59, // 1: api.GetAccountInfoResponse.account:type_name -> api.Account
	60, // 2: api.ImportCsvRequest.mapping_options:type_name -> api.MappingOptionItem
	61, // 3: api.ImportCsvRequest.configurations:type_name -> api.ImportCsvConfigurations
	45, // 4: api.GetListDataSourcesResponse.results:type_name -> api.GetListDataSourcesResponse.DataSource
	46, // 5: api.GetDataSourceResponse.configurations:type_name -> api.GetDataSourceResponse.ConfigurationsEntry
	47, // 6: api.GetDataSourceResponse.mapping_options:type_name -> api.GetDataSourceResponse.MappingOptionsEntry
	48, // 7: api.GetListDataTablesResponse.results:type_name -> api.GetListDataTablesResponse.DataTable
	62, // 8: api.GetDataTableResponse.schema:type_name -> api.SchemaColumn
	49, // 9: api.CreateConnectionRequest.configurations:type_name -> api.CreateConnectionRequest.ConfigurationsEntry
	50, // 10: api.GetListConnectionsResponse.results:type_name -> api.GetListConnectionsResponse.Connection
	51, // 11: api.GetConnectionResponse.configurations:type_name -> api.GetConnectionResponse.ConfigurationsEntry
	52, // 12: api.UpdateConnectionRequest.configurations:type_name -> api.UpdateConnectionRequest.ConfigurationsEntry
	53, // 13: api.GetListFileExportRecordsResponse.results:type_name -> api.GetListFileExportRecordsResponse.FileExportRecord
	60, // 14: api.ImportCsvFromS3Request.mapping_options:type_name -> api.MappingOptionItem
	61, // 15: api.ImportCsvFromS3Request.configurations:type_name -> api.ImportCsvConfigurations
	63, // 16: api.CreateMasterSegmentRequest.selected_columns:type_name -> api.TransferredColumn
	54, // 17: api.CreateMasterSegmentRequest.attribute_tables:type_name -> api.CreateMasterSegmentRequest.AttributeTable
	55, // 18: api.CreateMasterSegmentRequest.behavior_tables:type_name -> api.CreateMasterSegmentRequest.BehaviorTable
	64, // 19: api.GetListMasterSegmentsResponse.results:type_name -> api.MasterSegment
	56, // 20: api.GetMasterSegmentDetailResponse.attribute_tables:type_name -> api.GetMasterSegmentDetailResponse.AttributeTable
	57, // 21: api.GetMasterSegmentDetailResponse.behavior_tables:type_name -> api.GetMasterSegmentDetailResponse.BehaviorTable
	62, // 22: api.GetMasterSegmentDetailResponse.audience_schema:type_name -> api.SchemaColumn
	58, // 23: api.CreateSegmentRequest.condition:type_name -> api.CreateSegmentRequest.Rule
	65, // 24: api.GetListSegmentsResponse.results:type_name -> api.Segment
	63, // 25: api.CreateMasterSegmentRequest.AttributeTable.selected_columns:type_name -> api.TransferredColumn
	63, // 26: api.CreateMasterSegmentRequest.BehaviorTable.selected_columns:type_name -> api.TransferredColumn
	63, // 27: api.GetMasterSegmentDetailResponse.AttributeTable.selected_columns:type_name -> api.TransferredColumn
	62, // 28: api.GetMasterSegmentDetailResponse.BehaviorTable.schema:type_name -> api.SchemaColumn
	58, // 29: api.CreateSegmentRequest.Rule.rules:type_name -> api.CreateSegmentRequest.Rule
	...
	17, // 38: api.CDPService.GetQueryDataTable:input_type -> api.GetQueryDataTableRequest
	23, // 39: api.CDPService.GetConnection:input_type -> api.GetConnectionRequest
	21, // 40: api.CDPService.GetListConnections:input_type -> api.GetListConnectionsRequest
	19, // 41: api.CDPService.CreateConnection:input_type -> api.CreateConnectionRequest
	25, // 42: api.CDPService.UpdateConnection:input_type -> api.UpdateConnectionRequest
	27, // 43: api.CDPService.DeleteConnection:input_type -> api.DeleteConnectionRequest
	29, // 44: api.CDPService.ExportDataTableToFile:input_type -> api.ExportDataTableToFileRequest
	33, // 45: api.CDPService.ImportCsvFromS3:input_type -> api.ImportCsvFromS3Request
	31, // 46: api.CDPService.GetListFileExportRecords:input_type -> api.GetListFileExportRecordsRequest
	35, // 47: api.CDPService.CreateMasterSegment:input_type -> api.CreateMasterSegmentRequest
	37, // 48: api.CDPService.GetListMasterSegments:input_type -> api.GetListMasterSegmentsRequest
	39, // 49: api.CDPService.GetMasterSegmentDetail:input_type -> api.GetMasterSegmentDetailRequest
	41, // 50: api.CDPService.CreateSegment:input_type -> api.CreateSegmentRequest
	43, // 51: api.CDPService.GetListSegments:input_type -> api.GetListSegmentsRequest
	6,  // 52: api.CDPService.CheckHealth:output_type -> api.CommonResponse
	2,  // 53: api.CDPService.Login:output_type -> api.LoginResponse
	6,  // 54: api.CDPService.SignUp:output_type -> api.CommonResponse
	5,  // 55: api.CDPService.GetAccountInfo:output_type -> api.GetAccountInfoResponse
	10, // 56: api.CDPService.GetListDataSources:output_type -> api.GetListDataSourcesResponse
	12, // 57: api.CDPService.GetDataSource:output_type -> api.GetDataSourceResponse
	14, // 58: api.CDPService.GetListDataTables:output_type -> api.GetListDataTablesResponse
	16, // 59: api.CDPService.GetDataTable:output_type -> api.GetDataTableResponse
	18, // 60: api.CDPService.GetQueryDataTable:output_type -> api.GetQueryDataTableResponse
	24, // 61: api.CDPService.GetConnection:output_type -> api.GetConnectionResponse
	22, // 62: api.CDPService.GetListConnections:output_type -> api.GetListConnectionsResponse
	20, // 63: api.CDPService.CreateConnection:output_type -> api.CreateConnectionResponse
	26, // 64: api.CDPService.UpdateConnection:output_type -> api.UpdateConnectionResponse
	28, // 65: api.CDPService.DeleteConnection:output_type -> api.DeleteConnectionResponse
	30, // 66: api.CDPService.ExportDataTableToFile:output_type -> api.ExportDataTableToFileResponse
	34, // 67: api.CDPService.ImportCsvFromS3:output_type -> api.ImportCsvFromS3Response
	32, // 68: api.CDPService.GetListFileExportRecords:output_type -> api.GetListFileExportRecordsResponse
	36, // 69: api.CDPService.CreateMasterSegment:output_type -> api.CreateMasterSegmentResponse
	38, // 70: api.CDPService.GetListMasterSegments:output_type -> api.GetListMasterSegmentsResponse
	40, // 71: api.CDPService.GetMasterSegmentDetail:output_type -> api.GetMasterSegmentDetailResponse
	42, // 72: api.CDPService.CreateSegment:output_type -> api.CreateSegmentResponse
	44, // 73: api.CDPService.GetListSegments:output_type -> api.GetListSegmentsResponse
