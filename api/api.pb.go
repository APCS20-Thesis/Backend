...
type GetSegmentDetailResponse struct {
	...
	// condition
	Condition *Rule `protobuf:"bytes,10,opt,name=condition,proto3" json:"condition,omitempty"`
	// schema
...
func (x *GetSegmentDetailResponse) GetCondition() *Rule {
	if x != nil {
		return x.Condition
	}
	return nil
...
var file_api_proto_rawDesc = []byte{
	...
	0x52, 0x02, 0x69, 0x64, 0x22, 0xfc, 0x02, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x53, 0x65, 0x67, 0x6d,
	0x65, 0x6e, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	0x27, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x09, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x52, 0x75, 0x6c, 0x65, 0x52, 0x09, 0x63,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*MappingGophishProfile)(nil),   // 106: api.MappingGophishProfile
	(*DataDestination)(nil),         // 107: api.DataDestination
	(*DataAction)(nil),              // 108: api.DataAction
	(*PredictModel)(nil),            // 109: api.PredictModel
	(*SourceTableMap)(nil),          // 110: api.SourceTableMap
	(*EnrichedMasterSegment)(nil),   // 111: api.EnrichedMasterSegment
	(*EnrichedSegment)(nil),         // 112: api.EnrichedSegment
	(*EnrichedDataSource)(nil),      // 113: api.EnrichedDataSource
	(*EnrichedDataDestination)(nil), // 114: api.EnrichedDataDestination
}
var file_api_proto_depIdxs = []int32{
	...
	103, // 32: api.GetSegmentDetailResponse.condition:type_name -> api.Rule
	100, // 33: api.GetSegmentDetailResponse.schema:type_name -> api.SchemaColumn
	106, // 34: api.CreateGophishUserGroupFromSegmentRequest.mapping:type_name -> api.MappingGophishProfile
	97,  // 35: api.ImportFromMySQLSourceRequest.mapping_options:type_name -> api.MappingOptionItem
	107, // 36: api.GetListDataDestinationsResponse.results:type_name -> api.DataDestination
	108, // 37: api.GetListDataActionsResponse.results:type_name -> api.DataAction
	109, // 38: api.GetListPredictModelsResponse.results:type_name -> api.PredictModel
	110, // 39: api.GetListSourceTableMapResponse.results:type_name -> api.SourceTableMap
	99,  // 40: api.GetDataDestinationDetailResponse.connection:type_name -> api.EnrichedConnection
	111, // 41: api.GetPredictModelDetailResponse.master_segment:type_name -> api.EnrichedMasterSegment
	112, // 42: api.GetPredictModelDetailResponse.train_segments:type_name -> api.EnrichedSegment
	...
	113, // 45: api.GetListDataTablesResponse.DataTable.data_sources:type_name -> api.EnrichedDataSource
	114, // 46: api.GetListDataTablesResponse.DataTable.data_destinations:type_name -> api.EnrichedDataDestination
	113, // 47: api.GetListConnectionsResponse.Connection.data_sources:type_name -> api.EnrichedDataSource
	114, // 48: api.GetListConnectionsResponse.Connection.data_destinations:type_name -> api.EnrichedDataDestination
