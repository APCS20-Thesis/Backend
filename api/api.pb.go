...
var file_api_proto_msgTypes = make([]protoimpl.MessageInfo, 104)
var file_api_proto_goTypes = []interface{}{
	...
	(*GetListDataSourcesResponse_DataSource)(nil),     // 89: api.GetListDataSourcesResponse.DataSource
	nil, // 90: api.GetDataSourceResponse.MappingOptionsEntry
	(*GetListDataTablesResponse_DataTable)(nil), // 91: api.GetListDataTablesResponse.DataTable
	nil, // 92: api.CreateConnectionRequest.ConfigurationsEntry
	(*GetListConnectionsResponse_Connection)(nil), // 93: api.GetListConnectionsResponse.Connection
	nil, // 94: api.GetConnectionResponse.ConfigurationsEntry
	nil, // 95: api.UpdateConnectionRequest.ConfigurationsEntry
	(*GetListFileExportRecordsResponse_FileExportRecord)(nil),     // 96: api.GetListFileExportRecordsResponse.FileExportRecord
	(*CreateMasterSegmentRequest_AttributeTable)(nil),             // 97: api.CreateMasterSegmentRequest.AttributeTable
	(*CreateMasterSegmentRequest_BehaviorTable)(nil),              // 98: api.CreateMasterSegmentRequest.BehaviorTable
	(*GetMasterSegmentDetailResponse_AttributeTable)(nil),         // 99: api.GetMasterSegmentDetailResponse.AttributeTable
	(*GetMasterSegmentDetailResponse_BehaviorTable)(nil),          // 100: api.GetMasterSegmentDetailResponse.BehaviorTable
	(*GetListPredictionActionsResponse_PredictionAction)(nil),     // 101: api.GetListPredictionActionsResponse.PredictionAction
	(*GetDataActionRunsPerDayResponse_TotalActionRunsPerDay)(nil), // 102: api.GetDataActionRunsPerDayResponse.TotalActionRunsPerDay
	(*GetDataRunsProportionResponse_CategoryCount)(nil),           // 103: api.GetDataRunsProportionResponse.CategoryCount
	(*Account)(nil),                 // 104: api.Account
	(*Setting)(nil),                 // 105: api.Setting
	(*wrapperspb.BoolValue)(nil),    // 106: google.protobuf.BoolValue
	(*MappingOptionItem)(nil),       // 107: api.MappingOptionItem
	(*ImportCsvConfigurations)(nil), // 108: api.ImportCsvConfigurations
	(*EnrichedConnection)(nil),      // 109: api.EnrichedConnection
	(*SchemaColumn)(nil),            // 110: api.SchemaColumn
	(*TransferredColumn)(nil),       // 111: api.TransferredColumn
	(*MasterSegment)(nil),           // 112: api.MasterSegment
	(*Rule)(nil),                    // 113: api.Rule
	(*BehaviorCondition)(nil),       // 114: api.BehaviorCondition
	(*Segment)(nil),                 // 115: api.Segment
	(*SegmentCondition)(nil),        // 116: api.SegmentCondition
	(*MappingGophishProfile)(nil),   // 117: api.MappingGophishProfile
	(*DataDestination)(nil),         // 118: api.DataDestination
	(*DataActionRun)(nil),           // 119: api.DataActionRun
	(*PredictModel)(nil),            // 120: api.PredictModel
	(*SourceTableMap)(nil),          // 121: api.SourceTableMap
	(*EnrichedMasterSegment)(nil),   // 122: api.EnrichedMasterSegment
	(*EnrichedSegment)(nil),         // 123: api.EnrichedSegment
	(*EnrichedDataSource)(nil),      // 124: api.EnrichedDataSource
	(*EnrichedDataDestination)(nil), // 125: api.EnrichedDataDestination
}
var file_api_proto_depIdxs = []int32{
	104, // 0: api.GetAccountInfoResponse.account:type_name -> api.Account
	105, // 1: api.GetAccountInfoResponse.setting:type_name -> api.Setting
	104, // 2: api.UpdateAccountInfoResponse.account:type_name -> api.Account
	106, // 3: api.UpdateAccountSettingRequest.notify_create_source:type_name -> google.protobuf.BoolValue
	106, // 4: api.UpdateAccountSettingRequest.notify_create_destination:type_name -> google.protobuf.BoolValue
	106, // 5: api.UpdateAccountSettingRequest.notify_create_master_segment:type_name -> google.protobuf.BoolValue
	106, // 6: api.UpdateAccountSettingRequest.notify_create_segment:type_name -> google.protobuf.BoolValue
	105, // 7: api.UpdateAccountSettingResponse.setting:type_name -> api.Setting
	107, // 8: api.ImportCsvRequest.mapping_options:type_name -> api.MappingOptionItem
	108, // 9: api.ImportCsvRequest.configurations:type_name -> api.ImportCsvConfigurations
	89,  // 10: api.GetListDataSourcesResponse.results:type_name -> api.GetListDataSourcesResponse.DataSource
	90,  // 11: api.GetDataSourceResponse.mapping_options:type_name -> api.GetDataSourceResponse.MappingOptionsEntry
	109, // 12: api.GetDataSourceResponse.connection:type_name -> api.EnrichedConnection
	91,  // 13: api.GetListDataTablesResponse.results:type_name -> api.GetListDataTablesResponse.DataTable
	110, // 14: api.GetDataTableResponse.schema:type_name -> api.SchemaColumn
	92,  // 15: api.CreateConnectionRequest.configurations:type_name -> api.CreateConnectionRequest.ConfigurationsEntry
	93,  // 16: api.GetListConnectionsResponse.results:type_name -> api.GetListConnectionsResponse.Connection
	94,  // 17: api.GetConnectionResponse.configurations:type_name -> api.GetConnectionResponse.ConfigurationsEntry
	95,  // 18: api.UpdateConnectionRequest.configurations:type_name -> api.UpdateConnectionRequest.ConfigurationsEntry
	96,  // 19: api.GetListFileExportRecordsResponse.results:type_name -> api.GetListFileExportRecordsResponse.FileExportRecord
	107, // 20: api.ImportCsvFromS3Request.mapping_options:type_name -> api.MappingOptionItem
	108, // 21: api.ImportCsvFromS3Request.configurations:type_name -> api.ImportCsvConfigurations
	111, // 22: api.CreateMasterSegmentRequest.selected_columns:type_name -> api.TransferredColumn
	97,  // 23: api.CreateMasterSegmentRequest.attribute_tables:type_name -> api.CreateMasterSegmentRequest.AttributeTable
	98,  // 24: api.CreateMasterSegmentRequest.behavior_tables:type_name -> api.CreateMasterSegmentRequest.BehaviorTable
	112, // 25: api.GetListMasterSegmentsResponse.results:type_name -> api.MasterSegment
	99,  // 26: api.GetMasterSegmentDetailResponse.attribute_tables:type_name -> api.GetMasterSegmentDetailResponse.AttributeTable
	100, // 27: api.GetMasterSegmentDetailResponse.behavior_tables:type_name -> api.GetMasterSegmentDetailResponse.BehaviorTable
	110, // 28: api.GetMasterSegmentDetailResponse.audience_schema:type_name -> api.SchemaColumn
	113, // 29: api.CreateSegmentRequest.condition:type_name -> api.Rule
	114, // 30: api.CreateSegmentRequest.behavior_conditions:type_name -> api.BehaviorCondition
	115, // 31: api.GetListSegmentsResponse.results:type_name -> api.Segment
	116, // 32: api.GetSegmentDetailResponse.condition:type_name -> api.SegmentCondition
	110, // 33: api.GetSegmentDetailResponse.schema:type_name -> api.SchemaColumn
	117, // 34: api.CreateGophishUserGroupFromSegmentRequest.mapping:type_name -> api.MappingGophishProfile
	107, // 35: api.ImportFromMySQLSourceRequest.mapping_options:type_name -> api.MappingOptionItem
	118, // 36: api.GetListDataDestinationsResponse.results:type_name -> api.DataDestination
	119, // 37: api.GetListDataActionRunsResponse.results:type_name -> api.DataActionRun
	120, // 38: api.GetListPredictModelsResponse.results:type_name -> api.PredictModel
	121, // 39: api.GetListSourceTableMapResponse.results:type_name -> api.SourceTableMap
	109, // 40: api.GetDataDestinationDetailResponse.connection:type_name -> api.EnrichedConnection
	122, // 41: api.GetPredictModelDetailResponse.master_segment:type_name -> api.EnrichedMasterSegment
	123, // 42: api.GetPredictModelDetailResponse.train_segments:type_name -> api.EnrichedSegment
	110, // 43: api.GetMySQLTableSchemaResponse.schema:type_name -> api.SchemaColumn
	101, // 44: api.GetListPredictionActionsResponse.results:type_name -> api.GetListPredictionActionsResponse.PredictionAction
	102, // 45: api.GetDataActionRunsPerDayResponse.results:type_name -> api.GetDataActionRunsPerDayResponse.TotalActionRunsPerDay
	103, // 46: api.GetDataRunsProportionResponse.results:type_name -> api.GetDataRunsProportionResponse.CategoryCount
	124, // 47: api.GetListDataTablesResponse.DataTable.data_sources:type_name -> api.EnrichedDataSource
	125, // 48: api.GetListDataTablesResponse.DataTable.data_destinations:type_name -> api.EnrichedDataDestination
	124, // 49: api.GetListConnectionsResponse.Connection.data_sources:type_name -> api.EnrichedDataSource
	125, // 50: api.GetListConnectionsResponse.Connection.data_destinations:type_name -> api.EnrichedDataDestination
	111, // 51: api.CreateMasterSegmentRequest.AttributeTable.selected_columns:type_name -> api.TransferredColumn
	111, // 52: api.CreateMasterSegmentRequest.BehaviorTable.selected_columns:type_name -> api.TransferredColumn
	111, // 53: api.GetMasterSegmentDetailResponse.AttributeTable.selected_columns:type_name -> api.TransferredColumn
	110, // 54: api.GetMasterSegmentDetailResponse.BehaviorTable.schema:type_name -> api.SchemaColumn
	...
	10,  // 99: api.CDPService.CheckHealth:output_type -> api.CommonResponse
	2,   // 100: api.CDPService.Login:output_type -> api.LoginResponse
	10,  // 101: api.CDPService.SignUp:output_type -> api.CommonResponse
	5,   // 102: api.CDPService.GetAccountInfo:output_type -> api.GetAccountInfoResponse
	7,   // 103: api.CDPService.UpdateAccountInfo:output_type -> api.UpdateAccountInfoResponse
	9,   // 104: api.CDPService.UpdateAccountSetting:output_type -> api.UpdateAccountSettingResponse
	14,  // 105: api.CDPService.GetListDataSources:output_type -> api.GetListDataSourcesResponse
	16,  // 106: api.CDPService.GetDataSource:output_type -> api.GetDataSourceResponse
	18,  // 107: api.CDPService.GetListDataTables:output_type -> api.GetListDataTablesResponse
	20,  // 108: api.CDPService.GetDataTable:output_type -> api.GetDataTableResponse
	22,  // 109: api.CDPService.GetQueryDataTable:output_type -> api.GetQueryDataTableResponse
	28,  // 110: api.CDPService.GetConnection:output_type -> api.GetConnectionResponse
	26,  // 111: api.CDPService.GetListConnections:output_type -> api.GetListConnectionsResponse
	24,  // 112: api.CDPService.CreateConnection:output_type -> api.CreateConnectionResponse
	30,  // 113: api.CDPService.UpdateConnection:output_type -> api.UpdateConnectionResponse
	32,  // 114: api.CDPService.DeleteConnection:output_type -> api.DeleteConnectionResponse
	34,  // 115: api.CDPService.ExportDataToFile:output_type -> api.ExportDataToFileResponse
	38,  // 116: api.CDPService.ImportCsvFromS3:output_type -> api.ImportCsvFromS3Response
	36,  // 117: api.CDPService.GetListFileExportRecords:output_type -> api.GetListFileExportRecordsResponse
	40,  // 118: api.CDPService.CreateMasterSegment:output_type -> api.CreateMasterSegmentResponse
	42,  // 119: api.CDPService.GetListMasterSegments:output_type -> api.GetListMasterSegmentsResponse
	44,  // 120: api.CDPService.GetMasterSegmentDetail:output_type -> api.GetMasterSegmentDetailResponse
	46,  // 121: api.CDPService.CreateSegment:output_type -> api.CreateSegmentResponse
	48,  // 122: api.CDPService.GetListSegments:output_type -> api.GetListSegmentsResponse
	50,  // 123: api.CDPService.GetSegmentDetail:output_type -> api.GetSegmentDetailResponse
	52,  // 124: api.CDPService.CreateGophishUserGroupFromSegment:output_type -> api.CreateGophishUserGroupFromSegmentResponse
	54,  // 125: api.CDPService.ImportFromMySQLSource:output_type -> api.ImportFromMySQLSourceResponse
	56,  // 126: api.CDPService.ExportToMySQLDestination:output_type -> api.ExportToMySQLDestinationResponse
	58,  // 127: api.CDPService.GetListDataDestinations:output_type -> api.GetListDataDestinationsResponse
	60,  // 128: api.CDPService.GetListDataActionRuns:output_type -> api.GetListDataActionRunsResponse
	62,  // 129: api.CDPService.TrainPredictModel:output_type -> api.TrainPredictModelResponse
	64,  // 130: api.CDPService.GetListPredictModels:output_type -> api.GetListPredictModelsResponse
	66,  // 131: api.CDPService.GetListSourceTableMap:output_type -> api.GetListSourceTableMapResponse
	68,  // 132: api.CDPService.GetDataDestinationDetail:output_type -> api.GetDataDestinationDetailResponse
	70,  // 133: api.CDPService.GetPredictModelDetail:output_type -> api.GetPredictModelDetailResponse
	72,  // 134: api.CDPService.GetMySQLTableSchema:output_type -> api.GetMySQLTableSchemaResponse
	74,  // 135: api.CDPService.GetListMasterSegmentProfiles:output_type -> api.GetListMasterSegmentProfilesResponse
	76,  // 136: api.CDPService.ApplyPredictModel:output_type -> api.ApplyPredictModelResponse
	78,  // 137: api.CDPService.GetListPredictionActions:output_type -> api.GetListPredictionActionsResponse
	80,  // 138: api.CDPService.TriggerDataActionRun:output_type -> api.TriggerDataActionRunResponse
	82,  // 139: api.CDPService.GetMasterSegmentProfile:output_type -> api.GetMasterSegmentProfileResponse
	84,  // 140: api.CDPService.GetResultPredictionActions:output_type -> api.GetResultPredictionActionsResponse
	86,  // 141: api.CDPService.GetDataActionRunsPerDay:output_type -> api.GetDataActionRunsPerDayResponse
	88,  // 142: api.CDPService.GetDataRunsProportion:output_type -> api.GetDataRunsProportionResponse
