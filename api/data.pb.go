...
type MappingOption struct {
	...
	// source_field - field in data source
	SourceField string `protobuf:"bytes,1,opt,name=source_field,json=sourceField,proto3" json:"source_field,omitempty"`
	// dest_field - field in destination delta table
	DestField string `protobuf:"bytes,2,opt,name=dest_field,json=destField,proto3" json:"dest_field,omitempty"`
}

func (x *MappingOption) Reset() {
	*x = MappingOption{}
	if protoimpl.UnsafeEnabled {
...
func (x *MappingOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MappingOption) ProtoMessage() {}

func (x *MappingOption) ProtoReflect() protoreflect.Message {
	mi := &file_data_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MappingOption.ProtoReflect.Descriptor instead.
func (*MappingOption) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{1}
}

func (x *MappingOption) GetSourceField() string {
	if x != nil {
...
func (x *MappingOption) GetDestField() string {
	if x != nil {
		return x.DestField
	}
	return ""
...
var file_data_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x6d, 0x61, 0x69, 0x6c, 0x22, 0x51, 0x0a, 0x0d, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x4f,
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x66, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x65, 0x73, 0x74,
	0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x65,
	0x73, 0x74, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_data_proto_goTypes = []interface{}{
	...
	(*MappingOption)(nil), // 1: api.MappingOption
}
