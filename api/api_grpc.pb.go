...
type CDPServiceClient interface {
	...
	CreateDataSourceMySQL(ctx context.Context, in *CreateDataSourceMySQLRequest, opts ...grpc.CallOption) (*CreateDataSourceMySQLResponse, error)
}
...
func (c *cDPServiceClient) CreateDataSourceMySQL(ctx context.Context, in *CreateDataSourceMySQLRequest, opts ...grpc.CallOption) (*CreateDataSourceMySQLResponse, error) {
	out := new(CreateDataSourceMySQLResponse)
	err := c.cc.Invoke(ctx, "/api.CDPService/CreateDataSourceMySQL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CDPServiceServer interface {
	...
	CreateDataSourceMySQL(context.Context, *CreateDataSourceMySQLRequest) (*CreateDataSourceMySQLResponse, error)
...
func (UnimplementedCDPServiceServer) CreateDataSourceMySQL(context.Context, *CreateDataSourceMySQLRequest) (*CreateDataSourceMySQLResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDataSourceMySQL not implemented")
}
...
func _CDPService_CreateDataSourceMySQL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDataSourceMySQLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CDPServiceServer).CreateDataSourceMySQL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.CDPService/CreateDataSourceMySQL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CDPServiceServer).CreateDataSourceMySQL(ctx, req.(*CreateDataSourceMySQLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CDPService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateDataSourceMySQL",
			Handler:    _CDPService_CreateDataSourceMySQL_Handler,
		},
	},
